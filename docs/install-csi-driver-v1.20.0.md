## Install SMB CSI driver v1.20.0 version on a Kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-csi/csi-driver-smb/v1.20.0/deploy/uninstall-driver.sh | bash -s --
```
